...
- Quando o usuário substitui a capa por outra ou remove a capa na edição do livro, a referência no livro é atualizada/removida, e o arquivo antigo pode ser excluído do disco com segurança se órfão.
